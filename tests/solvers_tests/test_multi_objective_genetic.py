...
import csv
import numpy as np
from solvers.multi_objective_genetic_solver import MultiObjectiveGeneticSolver
from tests.utils import read_prob

def test_multi_objective_genetic_solver():
    solver = MultiObjectiveGeneticSolver(time_limit=10, population_size=20, generations=50)
    results = []
    ...
    results_file = os.path.join(PROJECT_ROOT, 'results', 'multi_objective_genetic_results.csv')
...
if __name__ == '__main__':
    test_multi_objective_genetic_solver()
