...
import csv
import numpy as np
from solvers.greedy_solver_vali import NearestNeighbourSolverVali
from tests.utils import read_prob

def test_greedy_vali_solver():
    ...
    results_file = os.path.join(PROJECT_ROOT, 'results', 'greedy_vali_results.csv')
