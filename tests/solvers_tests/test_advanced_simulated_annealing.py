...
from solvers import AdvancedSimulatedAnnealingSolver
...
def main():
    solver = AdvancedSimulatedAnnealingSolver(time_limit=10)

    os.makedirs('results', exist_ok=True)
    out_path = 'results/advanced_simulated_annealing_results.csv'
