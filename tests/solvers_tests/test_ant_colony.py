...
import csv
import numpy as np
from solvers.ant_colony_solver import AntColonySolver
from tests.utils import read_prob

def test_ant_colony_solver():
    solver = AntColonySolver(time_limit=10, n_ants=20, n_iterations=50)
    results = []
    ...
    results_file = os.path.join(PROJECT_ROOT, 'results', 'ant_colony_results.csv')
