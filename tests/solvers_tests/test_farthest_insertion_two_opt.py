...
from solvers import FarthestInsertionTwoOptSolver
...
def main():
    solver = FarthestInsertionTwoOptSolver(time_limit=10)

    os.makedirs('results', exist_ok=True)
    out_path = 'results/farthest_insertion_two_opt_results.csv'
