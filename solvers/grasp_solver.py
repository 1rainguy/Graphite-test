...
from .common_utils import two_opt_improve, nearest_neighbor
import numpy as np
import time
import random
...
class GRASPSolver:
    ...
    def __init__(self, time_limit: int = 100, max_iterations: int = 1000,
    ...
    def solve(self, formatted_problem) -> List[int]:
        ...
        if best_solution is None:
            fallback_solution = nearest_neighbor(distance_matrix, start=0, start_time=start_time, hard_limit=self.time_limit)
